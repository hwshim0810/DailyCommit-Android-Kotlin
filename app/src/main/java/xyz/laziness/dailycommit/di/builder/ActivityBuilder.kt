...
import xyz.laziness.dailycommit.ui.modules.main.friends.FriendsStatusProvider
...
abstract class ActivityBuilder {
    ...
    @ContributesAndroidInjector(modules = [(MainModule::class), (UserStatusProvider::class), (FriendsStatusProvider::class)])
